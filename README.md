...
Whoever Wants is a lightweight, anonymous questioning app that helps groups make decisions together. Whether you're deciding where to eat, what movie to watch, or any other group decision - this tool makes it easy to collect everyone's preferences without the hassle of accounts or sign-ups.

## Features

- **No accounts required** - Create and vote on questions completely anonymously
- **Yes/No questions** - Simple binary decisions
- **Ranked choice voting** - Instant-runoff voting with Borda tiebreak for multi-option consensus
- **Suggestion questions** - Let voters suggest and vote on options
- **Participation questions** - RSVP with min/max constraints and conditional attendance
- **Time-limited questions** - Set deadlines to keep decisions moving

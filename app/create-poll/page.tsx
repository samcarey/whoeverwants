  ...
  const titleField = (
    <div className="flex items-center justify-between gap-3 h-12">
      ...
      <input
        ...
        disabled={isLoading}
        maxLength={100}
        className="flex-1 min-w-0 text-base bg-transparent text-gray-700 dark:text-gray-300 text-right focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed placeholder:text-gray-400 dark:placeholder:text-gray-500 placeholder:italic"
                  ...
                  <section className="rounded-3xl bg-white dark:bg-gray-800 px-4">
                    <div className="flex items-center justify-between gap-3 h-12">
                      ...
                      <button
                        ...
                        disabled={isLoading}
                        className="text-base font-normal text-gray-700 dark:text-gray-300 disabled:opacity-50"

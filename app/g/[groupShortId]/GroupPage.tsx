      ...
      >
        ...
        {sections.map((section, sectionIdx) => (
          <React.Fragment key={section.tab}>
            <div
              className={`${sectionIdx > 0 ? "mt-6" : ""} border-b-2 ${ROW_DIVIDER_CLASS} pl-[0.9rem] pr-[0.65rem] pt-3 pb-1.5 text-2xl font-semibold uppercase tracking-wide text-gray-500 dark:text-gray-400`}
            >
              {section.label}
            </div>

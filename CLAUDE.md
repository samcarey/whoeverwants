...
**Status**: phasing plan in `docs/multipoll-phasing.md`. **Phases 1, 2.1, 2.2, 2.3, 2.4, 2.5, 3.1, 3.2 (incl. stacked-pill follow-up), and 4 shipped** (Phase 5 column drops still pending; Phase 3.3 unified Submit + multi-yes_no group external rendering still deferred):

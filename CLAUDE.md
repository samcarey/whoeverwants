...
**Status**: phasing plan in `docs/multipoll-phasing.md`. **Phases 1, 2.1, 2.2, 2.3, 2.4, 2.5, 3.1, 3.2, and 4 shipped** (Phase 5 column drops still pending; stacked compact pills + Phase 3.3 unified Submit are Phase 3.2 follow-ups):

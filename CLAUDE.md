...
**Status**: phasing plan in `docs/multipoll-phasing.md`. **Phases 1, 2.1, 2.2, 2.3, 2.5, and 4 shipped** (Phase 2.4 multi-sub-poll create UI + Phase 3 thread-card aggregation + Phase 5 column drops still pending):

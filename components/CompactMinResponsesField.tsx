      ...
      <div className="flex items-center justify-between gap-3 h-12">
        ...
        {isEditing ? (
          <input
            ...
            disabled={disabled}
            className="w-16 text-base bg-transparent text-gray-700 dark:text-gray-300 text-right focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
          />
        ) : (
          <button
            type="button"
            ...
            disabled={disabled}
            className="text-base font-normal text-gray-700 dark:text-gray-300 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {value}
          </button>
        )}

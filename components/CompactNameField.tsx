  ...
  return (
    <div className="flex items-center justify-between gap-3 h-12">
      ...
      <input
        ...
        disabled={disabled}
        maxLength={maxLength}
        className="flex-1 min-w-0 text-base bg-transparent text-gray-700 dark:text-gray-300 text-right focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
      />
    </div>
  );
}

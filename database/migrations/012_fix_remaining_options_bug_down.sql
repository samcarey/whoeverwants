...
DECLARE
    ...
    remaining_options TEXT[];  -- Bug: inconsistent type
    total_ballots INT;
...
BEGIN
    ...
    LOOP
        ...
        IF max_votes >= majority_threshold OR array_length(remaining_options, 1) <= 1 THEN  -- Bug: remaining_options is INT not array
            EXIT;
        END IF;

...
-- This restores the buggy version for rollback purposes
...
DECLARE
    ...
    remaining_options TEXT[];  -- BUG: This should be INT but was declared as array
    total_ballots INT;
...
BEGIN
    ...
    LOOP
        ...
        -- BUG: This line tries to use array_length on an INT variable

-- Fix Round 1 tie-breaking: ensure the function doesn't exit early when candidates
-- are tied but don't have majority. The function should proceed to elimination.
...
BEGIN
    ...
    LOOP
        ...
        -- FIXED: Exit conditions - only exit if there's a true majority OR only one candidate left
        -- Don't exit just because someone has the most votes without majority

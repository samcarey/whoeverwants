-- Add Borda count tie-breaking for ranked choice voting
-- This enables comeback mechanics by using Borda scoring to break ties for last place
-- Only candidates with lowest vote count participate in Borda calculation

...
export function toPoll(data: any): Poll {
  return {
    ...
    viewer_responded: data.viewer_responded ?? false,
    ...
    recurrence_skip_dates: Array.isArray(data.recurrence_skip_dates) ? data.recurrence_skip_dates : [],
    recurrence_until: data.recurrence_until ?? null,
    recurrence_anchor_id: data.recurrence_anchor_id ?? null,
    variant_parent_id: data.variant_parent_id ?? null,
    variant_root_id: data.variant_root_id ?? null,
    variant_direction: data.variant_direction === 'up' || data.variant_direction === 'down' ? data.variant_direction : null,
    variant_generation: typeof data.variant_generation === 'number' ? data.variant_generation : 0,

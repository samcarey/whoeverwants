// Debug test to see actual IRV results - run with: npm test -- debug-specific-tests.js
// Requires API server to be running (skips otherwise)
...
describe('Debug Actual Results', () => {
  it('Test 1: What actually happens', async ({ skip }) => {
    if (!apiUp) skip()
  ...
  it('Test 2: What actually happens', async ({ skip }) => {
    if (!apiUp) skip()
  ...
  it('Test 3: What actually happens', async ({ skip }) => {
    if (!apiUp) skip()

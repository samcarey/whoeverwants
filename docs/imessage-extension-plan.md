...
- **iMessage App Icon set** generated by `scripts/ios/gen-imessage-icon.py`
  (composites the app's transparent-corner 👋 mark onto opaque-black canvases at
  the full 13-image Xcode-canonical set — square 29×29 + square 1024×1024 + the
  3:2 Messages sizes + the 1024×768 App Store icon; a partial set is a hard
  actool archive failure).
